let User,Stripe,queryString,Hotel,Order;_7a4‍.x([["createConnectAccount",()=>createConnectAccount],["getAccountStatus",()=>getAccountStatus],["getAccountBalance",()=>getAccountBalance],["payoutSetting",()=>payoutSetting],["stripeSessionId",()=>stripeSessionId],["stripeSuccess",()=>stripeSuccess]]);_7a4‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_7a4‍.w("stripe",[["default",["Stripe"],function(v){Stripe=v}]]);_7a4‍.w("query-string",[["default",["queryString"],function(v){queryString=v}]]);_7a4‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_7a4‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);
...
const stripe = Stripe(process.env.STRIPE_SECRET);
  ...
  _7a4‍.g.console.log("LOGIN LINK", link);
  res.send(link);
...
const updateDelayDays = async (accountId) => {
  ...
  try {
    ...
    _7a4‍.g.console.log("STRIPE PAYOUT SETTING ERR ", err);
  }
};
  ...
  try {
    ...
    _7a4‍.g.console.log("STRIPE SUCCESS ERR", err);
  }
};
